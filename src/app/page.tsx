						...
						return (
							...
							>
								...
								<div className="flex items-center gap-1">
									...
									<span className="text-xs text-sesame">· {pastry.total_checkins} check-ins</span>
								</div>
							</Link>
						);
					})}
					...
					>
						...
						<div className="flex items-center gap-3">
							...
							<div className="flex-1">
								<p className="text-sm font-medium text-espresso">{checkin.user.display_name}</p>
						...
						{/* Photo placeholder */}
						<div className="aspect-[4/5] w-full rounded-[12px] bg-parchment" />
						...
						{checkin.notes && (
							<p className="text-sm leading-relaxed text-ganache">&ldquo;{checkin.notes}&rdquo;</p>
						)}
